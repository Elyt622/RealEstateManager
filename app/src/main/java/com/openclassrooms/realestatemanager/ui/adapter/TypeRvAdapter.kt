...
class TypeRvAdapter(private var viewModel: AddPropertyViewModel, private val context: Context, private val dataSet: Array<Type>)
    : RecyclerView.Adapter<TypeRvAdapter.ViewHolder>(){
